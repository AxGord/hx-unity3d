...
@:native("UnityEngine.Quaternion") extern class Quaternion {
	...
	function LookRotation(forward:unityEngine.Vector3, upwards:unityEngine.Vector3 = Vector3.up):unityEngine.Quaternion;
	function Slerp(from:unityEngine.Quaternion, to:unityEngine.Quaternion, t:Float):unityEngine.Quaternion;
	function Lerp(from:unityEngine.Quaternion, to:unityEngine.Quaternion, t:Float):unityEngine.Quaternion;
